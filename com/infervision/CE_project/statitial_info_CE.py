...
save_path = '/media/tx-eva-data/Data4/CE_DATA/标注数据库/segmentation/dcm'
id_list = []
KVP_list = []
...
for file in os.listdir(path):
    ...
    for dcm_file in os.listdir(f_folder):
        count += 1
        dcm_file_path = os.path.join(f_folder, dcm_file)
