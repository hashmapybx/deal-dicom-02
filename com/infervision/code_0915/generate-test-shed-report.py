...
def deal_month_excel(mark_date, list_a):
    ...
    for excel_path in list_a:
        ...
        for row in range(0, rows):
            if row == 0:
                ...
                list_pid.append(sheet1.row_values(row)[3])  # pid
    ...
    for key, value_list in dict_pid.items():
        ...
        while pici > 0:
            ...
            workboot.save("/media/tx-eva-data/Data1/CFDA_file/数据标注/detection/new_train/shed_table/detection_test/%s.xls" % file_name)
            i += 1
            pici -= 1
...
if __name__ == '__main__':
    src_path = "/media/tx-eva-data/Data1/CFDA_file/数据标注/detection/split_test"
    get_file(src_path)
