...
def split_excel():
    ...
    :return:
    '''
    src_path = "/media/tx-eva-data/Data1/CFDA_file/数据标注/segmention_test.xlsx"
            ...
            for a in range(0, len(list_row_data)):
                for b in range(0, len(list_row_data[a])):
                    sheet2.write(a + 1, b, list_row_data[a][b], set_style_1('Time New Roman', 205,
                        ...
                        '宋体', 205, False))
            workboot.save('/media/tx-eva-data/Data1/CFDA_file/数据标注/segmention/split-test/%s.xls' % file_name)
...
def get_markData():
    ...
    :return:
    '''
    src_path = "/media/tx-eva-data/NAS/标注数据库/交付数据/segmention/test"
